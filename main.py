...
parser = argparse.ArgumentParser(description='Run style transfer/classifier.')
parser.add_argument('task', type=str, help='Model to run, style transfer or classifier')
parser.add_argument('mode', type=str, help='Mode to run the model, training or inference')
parser.add_argument('--input', type=str, help='Input text to transfer/classify', default='من میرم با بچه‌ها بازی کنم')
